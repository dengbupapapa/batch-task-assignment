...
function batchTaskAssignment() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
        ...
        _ref$unitMaximum = _ref.unitMaximum,
        unitMaximum = _ref$unitMaximum === undefined ? 10 : _ref$unitMaximum;
    ...
    return function dispose(disposeFn) {
        ...
        function unitMaximumSpliceTasksAndDisposeFn() {
            ...
            var unitDatas = datas.splice(0, unitMaximum);

            working = true;
            disposeFn(unitDatas, resolvesCallback);
        }

        //响应结果相关参数
        //因为不够取而导致遗留到下一阶段的暂存区
        var unitResultTemporaryStorage = [];
        ...
        function resolvesCallback(unitResult) {
            ...
            //在前面插入上一次递归遗留的数据
            unitResult.unshift.apply(unitResult, _toConsumableArray(unitResultTemporaryStorage.splice(0)));
            ...
            while (true) {
                ...
                //够取直接取
                var currentItemResult = unitResult.splice(0, tasks.dataLengths[0]);
            ...
            //剩余部分放暂存区
            unitResultTemporaryStorage.push.apply(unitResultTemporaryStorage, _toConsumableArray(unitResult));
        ...
        return function task(data) {
            ...
            return new _Promise(function (resolve) {
                ...
                (_tasks$datas = tasks.datas).push.apply(_tasks$datas, _toConsumableArray(data));
...
export default batchTaskAssignment;
